      ...
      <div className="container relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-primary">Respuesta en minutos</span>
          </motion.div>
          ...
          <p className="section-subtitle mb-12">
            Contáctanos ahora y recibe tu cuenta en minutos. Estamos disponibles 24/7 para ayudarte con cualquier duda.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <motion.a
              ...
              style={{ 
                ...
                boxShadow: '0 8px 30px rgba(0, 136, 204, 0.35)'
              }}
              whileHover={{ 
                boxShadow: '0 12px 40px rgba(0, 136, 204, 0.5)',
                y: -3
              }}
            >
